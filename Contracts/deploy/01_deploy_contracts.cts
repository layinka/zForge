  ...
  const yieldTokens = [
    {
      name: "Staked CORE",
      symbol: "stCORE",
      yieldRatePerBlock: 3,// should be divided by 1e8 // Math.floor(0.000008 * 1e18), // ~80% APY
      address:''
    },
    {
      name: "Staked BTC",
      symbol: "stBTC",
      yieldRatePerBlock: 2,// Math.floor(0.000005 * 1e18), // ~50% APY
      address:''
    },
    {
      name: "Dual Staked CORE and BTC",
      symbol: "dualStake",
      yieldRatePerBlock: 1, // Math.floor(0.000012 * 1e18), // ~120% APY
      address:''
    },
  ]
